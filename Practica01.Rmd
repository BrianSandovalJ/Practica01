...
unique(tablaFlot4$Respuesta == 200 & tablaFlot4$Origen)
length(unique(tablaFlot4$Respuesta == 200))
...
ggplot(frequency_data_frame, aes(x = Valor, y = Frecuencia)) +
  ...
  labs(title = "Frecuencia de 200, 400 y 500 en 'columna'", x = "Valor", y = "Frecuencia")
