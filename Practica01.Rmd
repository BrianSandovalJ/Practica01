...
#tablaji$url_length <- nchar(tablaji_one_hot$URL)

data_onehot <- one_hot(tablaji)
...
# Impute missing values using missForest (optional, consider built-in R functions as well)
if (!require("missForest")) install.packages("missForest")
library(missForest)

# Assuming 'tablaji' is your data frame

# Convert 'Tiempo' column to factor (if applicable)
tablaji$Tiempo <- factor(tablaji$Tiempo)
