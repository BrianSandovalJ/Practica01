...
tablaFlot4$Dia <- substr(tablaFlot4$Tiempo, 2, 3)
tablaFlot4$Hora <- substr(tablaFlot4$Tiempo, 5, 12)
...
# Assuming 'Hora' is a character vector and the format is YYYY-MM-DD HH:MM:SS
tablaFlot4$Tiempo <- tablaFlot4$Tiempo %>%
  str_remove_all("\\[|\\]")
tablaFlot4$Hora_POSIXct <- as.POSIXct(tablaFlot4$Tiempo, format = "DD %H:%M:%S")
