...
1/. Generar al menos 2 gráficos distintos que permitan visualizar alguna característica relevante de los datos analizados.

```{r , echo=T}
#barplot(tablaFlot4$Version, names.arg = tablaFlot4$Respuesta)
```